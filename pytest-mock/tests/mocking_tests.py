import pytest
from mocking_import import SomethingImport
from mocking_import2 import SomethingImport2
...
class TestMockingClass:
    ...
    def test_patch_imported_func(self, mocker):
        ...
        """
        mocker.patch(
            "mocking_import.some_import_func",
            return_value={"message": "patched"},
        )
        from mocking_import import some_import_func
    ...
    def test_patch_func_hook(self, mocker):
        ...
        """
        mocker.patch(
            "mocking_import2.some_export_func",
            return_value={"message": "patched"},
        )
        from mocking_import2 import SomethingImport2
    ...
    def test_patch_const_hook(self, mocker):
        ...
        mocker.patch("mocking_import.CONST", 20000)
        some = SomethingImport()
        assert some.val() == 20600
    ...
    def test_patch_with_direct_import(self, mocker):
        ...
        """
        mocker.patch("mocking_import.SomethingImport")
        ...
        from mocking_import import SomethingImport as SI
    ...
    def test_patch_other_module_hook(self, mocker):
        ...
        mocked_something_export = mocker.patch("mocking_import2.SomethingExport")
